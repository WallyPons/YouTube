...
----------------------------------------------
- EDIT_DISTANCE_SIMILARITY is in preview.
- EDIT_DISTANCE_SIMILARITY is available in Azure SQL Managed 
...
SELECT EDIT_DISTANCE_SIMILARITY(@VAL1, @VAL2) 
AS [EDIT_DISTANCE_SIMILARITY];
